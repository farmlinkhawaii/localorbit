<?php
class NHP_Options_select_hide_belows extends NHP_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			'nhp-opts-select-hide-belows-js', 
			NHP_OPTIONS_URL.'fields/select_hide_belows/field_select_hide_belows.js', 
			array('jquery'),
			time(),
			true
		);
