<?php
# ID BY PAGE NAME
function ts_get_ID_by_page_name($page_name)
{
	global $wpdb;
...
# PAGE NAME BY ID
function ts_get_name_by_page_ID($page_id)
{
	global $wpdb;
...
# DEPTH
function ts_get_depth($id = '', $depth = '', $i = 0)
{
	global $wpdb;
	global $post;
	...
	if($depth == '')
	{
		if(is_page())
		{
			...
			return ts_get_depth($id, $depth, $i);
		}
	}
	elseif($depth == "0")
	{	
