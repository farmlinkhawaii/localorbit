...
require_once( $shortcodes_dir . 'ts_flickrwidget.php' );
*/
// require_once( $shortcodes_dir . 'example.php' );
//path to directory to scan

// Add shortcodes classes 
$shortcodes_dir1s = glob($shortcodes_dir . "*.php");
 
//print each file name
foreach($shortcodes_dir1s as $shortcodes_dir1)
{
require_once($shortcodes_dir1);
};
