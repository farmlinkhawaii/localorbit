...
class WPBakeryShortCode_VC_Twitter extends WPBakeryShortCode {
    ...
    protected function content( $atts, $content = null ) {
        ...
        $output .= "\n\t\t\t".'<div class="tweets" data-tw_name="'.$twitter_name.'" data-tw_count="'.$tweets_count.'"></div> <p class="twitter_follow_button_wrap"><a class="wpb_follow_btn twitter_follow_button" href="http://twitter.com/'.$twitter_name.'">'.__("Follow us on twitter","TS").'</a></p>';
...
class WPBakeryShortCode_VC_TweetMeMe extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        $output = '<a href="http://twitter.com/share" class="twitter-share-button" data-count="'.$type.'">'. __("Tweet","TS") .'</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>'.$this->endBlockComment('tweetmeme')."\n";
        return $output;
    }
}
...
class WPBakeryShortCode_VC_flickr extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        $output .= "\n\t\t\t".'<p class="flickr_stream_wrap"><a class="wpb_follow_btn wpb_flickr_stream" href="http://www.flickr.com/photos/'. $flickr_id .'">'.__("View stream on flickr","TS").'</a></p>';
