...
class WPBakeryShortCode_ts_recent_post_2_widget extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		...
		$output1 = 	do_shortcode("[widget widget_name=Custom_Recent_Posts instance='items=".$Items."']");
