...
class WPBakeryShortCode_ts_popular_post_widget extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		...
		$output1 = 	do_shortcode("[widget widget_name=Custom_Popular_Posts instance='items=".$Items."']");
