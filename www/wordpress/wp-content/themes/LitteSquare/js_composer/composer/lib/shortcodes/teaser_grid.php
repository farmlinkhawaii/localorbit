    ...
    protected function content( $atts, $content = null ) {
        ...
        while ( $my_query->have_posts() ) {
            ...
            if ( $grid_link != 'link_no' ) {
                $link = '<a class="more-link" href="'. get_permalink($post_id) .'"'.$link_target.' title="'. sprintf( esc_attr__( 'Permalink to %s', 'js_composer' ), the_title_attribute( 'echo=0' ) ).'">'. __("Read more","TS") .'</a>';
            }
        ...
        if( $grid_template == 'filtered_grid' && $teasers && !empty($teaser_categories)) {
            ...
            $categories_list = wp_list_categories(array(
                ...
                'show_option_none'   => __('No categories',"TS"),
                'echo' => false
            ));
            */
            ...
            $categories_list_output .= '<li class="active"><a href="#" data-filter="*">' . __('All',"TS") . '</a></li>';
        ...
        else { $teasers = __("Nothing found." ,"TS"); }
