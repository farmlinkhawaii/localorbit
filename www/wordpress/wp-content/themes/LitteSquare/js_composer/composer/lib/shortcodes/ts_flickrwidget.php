...
class WPBakeryShortCode_vc_flickr_widget extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        extract(shortcode_atts(array(
            ...
            'el_position' => '',
			'el_class' => '',
            'flickr_name' => '52617155@N08',
            'flickr_title' => 'Envato',
			'flickr_items' => '9',
        ), $atts));
        $el_class = $this->getExtraClass($el_class);
        $width = wpb_translateColumnWidthToSpan($width);
		$output1 = 	do_shortcode("[widget widget_name=Custom_Flickr instance='flickr_id=".$flickr_name."&title=".$flickr_title."&items=".$flickr_items."']");
