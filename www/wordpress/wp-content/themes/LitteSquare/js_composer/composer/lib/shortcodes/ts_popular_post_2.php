...
class WPBakeryShortCode_ts_popular_post_2_widget extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		...
		$output1 = 	do_shortcode("[widget widget_name=Custom_Popular_Posts_2 instance='items=".$Items."']");
