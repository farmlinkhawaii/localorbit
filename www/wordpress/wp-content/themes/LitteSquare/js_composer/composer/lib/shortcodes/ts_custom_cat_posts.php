...
class WPBakeryShortCode_ts_category_post_widget extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		...
		$output1 = 	do_shortcode("[widget widget_name=Custom_Cat_Posts instance='cat_id=".$category_choice."&items='".$category_items."']");
