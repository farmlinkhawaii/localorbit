...
class WPBakeryShortCode_ts_category_widget extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		...
		$output1 = 	do_shortcode("[widget widget_name=Custom_Categories instance='title=".$widget_title."']");
