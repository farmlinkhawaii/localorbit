	...
	function save()
	{
		...
		if(lo3::is_admin())
		{
			...
			$market->import_fields(
				...
				'payment_allow_authorize','payment_allow_paypal','payment_allow_purchaseorder','payment_default_paypal','payment_default_purchaseorder',
		...
		else if(lo3::is_market())
		{
			$market->import_fields(
				...
				'market_profile','closed_note','buyer_types_description','bubble_offset'
			);
		}
		else
		{
