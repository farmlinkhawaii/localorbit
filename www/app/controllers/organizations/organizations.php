...
class core_controller_organizations extends core_controller
{
	...
	function invite_user()
	{
		...
		else
		{
			...
			core::process_command('emails/registration_invite',false,$core->data['email'],$url,core_db::col('select name from domains where domain_id='.$core->data['domain_id'],'name'));
