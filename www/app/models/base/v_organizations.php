...
class core_model_base_v_organizations extends core_model
{
	function init_fields()
	{
		...
		$this->add_field(new core_model_field(22,'org_is_deleted','int',8,'','v_organizations'));
		$this->add_field(new core_model_field(23,'composite_role','string',-4,'','v_organizations'));
		$this->init_data();
	}
}
?>