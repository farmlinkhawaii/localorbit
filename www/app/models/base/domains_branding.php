...
class core_model_base_domains_branding extends core_model
{
	function init_fields()
	{
		...
		$this->add_field(new core_model_field(3,'background_color','int',8,'','domains_branding'));
		$this->add_field(new core_model_field(4,'background_id','int',8,'','domains_branding'));
		$this->add_field(new core_model_field(5,'is_temp','int',8,'','domains_branding'));
		$this->init_data();
	}
}
?>